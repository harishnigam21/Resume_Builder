...
<meta charset="utf-8" />
<title>Resume Builder | Request Quote</title>
    ...
    <div class="col-md-9">                                                                                                                                        
                        ...
                        <input type="email" name="email" class="form-control" value="<?php echo $rw['email'];?>" readonly="true">                                            
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                                                                        
                                                 <label class="check">
                                             <input type="checkbox" class="icheckbox" name="cms" value="CMS (Content Management System)" />Resume Builder (Content Management System)</label><br>
                                             <label class="check">
