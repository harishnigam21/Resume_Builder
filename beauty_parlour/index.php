...
<head>
  <meta charset="UTF-8">
  <title>Netsil - Hair Salon Mockup</title>
...
<html lang="en" dir="ltr">
  ...
  <body>
    <header>
      <nav> 
        <a href=""><img src="../ui/Logo.png" style="height: 100px; width: 130px; top: 100px; left: -690px;" class="logo laptop"><img src="../ui/Logo.png" style="height: 80px; width: 100px; top: -30px; left: -110px;" class=" logo tablet"></a>
        <ul>
          <li><a href="">Home</a></li>
        ...
        <a href="" class="book"><ion-icon name="ellipsis-horizontal" class="iconNothing"></ion-icon>  Book Online</a>
    ...
    <main>
      <section class="title">
        <section class="contentWrapper">
          ...
          <h5>
            Divide your uniqueness by your hairs in style
          </h5>
        </section>
          <button class="black">
    ...
    <footer class="black">
      <section class="aboutUs">
        ...
        <p>
          Ayesh Beauty Salon is perspiciatis omnis iste natus laundres veritis et abster beatae vitae nunc sagittis interdum resustut accuman.
        </p>
      ...
      <section class="copyright">
        <span>
          Netsil &copy; all rights reserved
      </span>
    </footer>
